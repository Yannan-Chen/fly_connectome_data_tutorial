...
```{r plot3d_neuron_rgl, webgl=TRUE, fig.width=8, fig.height=6}
...
```{r plotly_neuron, fig.width=8, fig.height=6}
...
```{r simple_mesh_example, eval=FALSE, fig.width=8, fig.height=6}
