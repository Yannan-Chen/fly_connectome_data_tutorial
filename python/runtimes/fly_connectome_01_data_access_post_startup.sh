#!/bin/bash
# Tutorial 01 Runtime Script - Google Colab Compatible
...
echo "Clearing pandas to avoid conflicts..."
python3 -m pip uninstall -y pandas 2>/dev/null || true

# Install core packages (install in order: numpy first, then pandas)
